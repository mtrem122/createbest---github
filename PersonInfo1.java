public class PersonInfo1 {
    ...
    public static String firstName = "Marc-Frederick";
    public static String lastName = "Tremblay";
    public static int studentNo = 8603273;
    public static String description = "Likes to code";
